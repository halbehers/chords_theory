...
{
    setSectionName(juce::translate("synth_adsr_section_title").toStdString());
    displayBorder();
    displayBackground();
...
void SynthAdsrSection::changeListenerCallback(juce::ChangeBroadcaster* source)
{
...
void SynthAdsrSection::refreshDialLabels()
{
